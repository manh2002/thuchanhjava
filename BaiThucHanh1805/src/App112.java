...
public class App112{
  public static void main(String[] args) {
    ...
    Student student1 = new Student("Manh", 9);
    Student student2 = new Student("Lien", 2);
    Student student3 = new Student("Linh", 5);
    Student student4 = new Student("Phuong", 10); 
    Student student5 = new Student("Huy", 10); 
