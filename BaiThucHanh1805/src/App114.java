...
public class App114 {
  public static void main(String[] args){
    ...
    hashMap.put("2", new Student("2021050379", "Le Ngoc Lam", "E1"));
    hashMap.put("3", new Student("2021050441", "Tran Tien Manh", "C2"));
    hashMap.put("4", new Student("2021050383", "Ngyen Thi Lien", "C2"));
